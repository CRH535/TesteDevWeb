  ...
  return (
    <div className="home-container">
      <div className="home-content">
        ...
        <h1 className="home-welcome-title">Bem-vindo, {usuario.nome}!</h1>
        ...
        <div className="home-user-info">
          <div className="home-user-icon">👤</div>
        ...
        <div className="home-development-warning">
          <div className="home-warning-icon">⚠️</div>
          <h2 className="home-warning-title">Plataforma em Desenvolvimento</h2>
          <p className="home-warning-text">
            Esta plataforma ainda se encontra em fase de desenvolvimento ativo.
            No momento, não estão implementadas funcionalidades de venda,
            cadastro de anúncios ou qualquer outra funcionalidade comercial.
          </p>
        </div>
      </div>
    </div>
