...
// deixei em 420ms porque fica rápida, fluida e sem atrapalhar a experiência
...
function Home(props) {
  ...
  // uso uma lista pra permitir um novo efeito a cada clique
  ...
  // guardo todos os timeouts de remoção pra limpar corretamente ao desmontar
  var timeoutsAnimacaoCarrinho = useRef([]);

  // contador simples pra gerar ids únicos em cada animação
  ...
  function dispararAnimacaoCarrinho(evento) {
    ...
    // cada clique recebe um identificador próprio
    // isso permite remover exatamente a animação criada por ele
    ...
    // adiciono a nova animação à lista atual
